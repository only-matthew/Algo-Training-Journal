...
import { loadProblemDetail, loadRoadmapNode, ensureOverviewJournal, ensureFullJournal, initOverviewPage, initJournalPage, forceProblemDetailRefresh, clearForceRefresh, problemDetailSequence, nextProblemDetailSequence } from "./data.mjs";
...
export function renderJournal(journal, dataScope = "overview") {
  ...
  async function renderRoute() {
    ...
    if (parts[0] === "tags") {
      ...
      const { initTagRenderer } = await import("./data.mjs");
      initTagRenderer();
      return;
    }
    if (parts[0] === "roadmap") {
...
export function renderTags(tagIndexProvider) {
