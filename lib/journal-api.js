...
export function saveDateLog(date, problems, interval = {}) { return apiRequest(`/api/logs/date?date=${encodeURIComponent(date)}`, { method: "PUT", body: JSON.stringify({ problems, ...interval }) }); }
