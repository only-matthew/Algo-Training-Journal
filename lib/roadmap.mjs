...
export function roadmapProblemRowHtml(problem) {
  ...
  return `<div class="roadmap-problem-row">
    <div class="roadmap-problem-main">
      ...
      <div class="roadmap-problem-meta">${sourceBadge}${rating}${difficulty}${tagChips}${role}${note}</div>
    </div>
...
// 节点「相关训练记录」区块：nodeData.node.relatedRecords 缺失 / 为空时不输出。
function relatedRecordsSectionHtml(nodeData) {
  ...
  return `<section class="roadmap-related-section">
    <h2>📎 相关训练记录（按标签匹配）</h2>
    <p class="related-hint">队员日志中带该节点标签的题（不含题单内已列题目），共 ${related.length} 条。</p>
