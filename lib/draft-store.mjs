...
function parseDraft(raw, memberId, date) {
  ...
  try {
    ...
    if (!draft || typeof draft !== "object" || Array.isArray(draft)
      ...
      || (draft.interval !== undefined && (!draft.interval || typeof draft.interval !== "object" || Array.isArray(draft.interval)
        || (draft.interval.startedOn !== undefined && typeof draft.interval.startedOn !== "string")
        || (draft.interval.solvedOn !== undefined && typeof draft.interval.solvedOn !== "string")))
...
export function createDraftStore({
  ...
  return Object.freeze({
    ...
    save({ memberId, date, baseRevision = null, problems, exists, interval } = {}) {
      if (!isScope(memberId, date) || !Array.isArray(problems)
        || (baseRevision !== null && typeof baseRevision !== "string")
        || (interval !== undefined && (!interval || typeof interval !== "object" || Array.isArray(interval)
          || (interval.startedOn !== undefined && typeof interval.startedOn !== "string")
          || (interval.solvedOn !== undefined && typeof interval.solvedOn !== "string")))
      ...
      try {
        ...
        draft = { draftVersion: DRAFT_VERSION, memberId, date, baseRevision, problems: clone(problems), ...(exists === undefined ? {} : { exists }), ...(interval === undefined ? {} : { interval: clone(interval) }), savedAt };
