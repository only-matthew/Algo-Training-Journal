  ...
  div.innerHTML = `
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input id="prob-${index}-tags" type="text" class="form-input problem-tags" maxlength="${LOG_LIMITS.tags * (LOG_LIMITS.tag + 2)}" placeholder="如 DP、图论、二分（可使用逗号或顿号分隔，最多 ${LOG_LIMITS.tags} 个）" />
      </div>
      <div class="form-group">
