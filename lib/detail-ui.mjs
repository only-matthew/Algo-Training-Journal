...
export const knowledgeCategories = [
  ...
  { id: "basic", title: "基础算法", icon: "code", pattern: /模拟|高精度|排序|枚举|递推|递归|贪心|二分|三分|前缀|差分|离散化|分治|倍增|优化/ },
  { id: "structure", title: "数据结构", icon: "database", pattern: /数据结构|数组|栈|队列|链表|堆|并查集|线段树|树状数组|平衡树|ST表|集合/ },
  { id: "dp", title: "DP", icon: "grid", pattern: /DP|动态规划|背包/i },
  { id: "graph", title: "图论", icon: "graph", pattern: /图论|图的|最短路|生成树|网络流|拓扑|连通|LCA|二分图/i },
